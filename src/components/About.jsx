...
const About = () => {
  return (
      <div className='min-h-screen bg-primary flex justify-center text-white p-4   max-w-full gap-16 md:flex-row flex-col md:sticky top-0' id='about_scroll'>
          ...
          <img src={knife} alt="" className='md:mt-10 md:h-[80vh] md:mx-6 sm:w-[80px] md:w-auto mx-auto rotate-45 w-[50px] md:rotate-0 ' id='knife'/>
          <div className=' self-center flex flex-col md:basis-1/3 '>
