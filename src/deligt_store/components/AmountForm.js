...
const AmountForm = (props) => {
    ...
    return (
        ...
        >
            <div className="flex">
                {amt > 0 && (
                    <button type="button" className="px-1 rounded-full  mx-2">
                        <BsPatchMinusFill
                            style={{
                                width: "30px",
                                height: "30px",
                ...
                {amt > 0 && (
                    <div className="bg-primary text-golden p-2 rounded-full">
                        {amt}
                    </div>
                )}
                <button type="button" className="px-1 rounded-full  mx-2">
            ...
            <div>
                <button className="px-4 bg-primary text-golden mt-3 rounded-lg  font-poppins  font-semibold py-2 ">
                    Add to cart
                </button>
            </div>
